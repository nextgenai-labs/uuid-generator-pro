...
- Screenshots should show the application in both light and dark themes.
- The demo GIF should highlight the generation, copy, and export workflows.
- Keep file sizes small for fast page loading on Codester.
